...
const uri = 'mongodb+srv://harshilpatel0712:harshilpatel@trainingmaster.fwcjgxl.mongodb.net/?retryWrites=true&w=majority&appName=TrainingMaster';
...
async function run() {
  try {
    ...
    const database=client.db("trainingmaster");
...
app.get('/', (req, res) => {
  res.send('Training Management System Server is running')
})
